...
(function () {
    ...
    function injectMarkup() {
        ...
        style.textContent = `
            ...
            .pdfv-bar { flex-shrink: 0; display: flex; align-items: center; gap: 2px; min-height: 56px; padding: 0 4px; padding-top: env(safe-area-inset-top, 0px); background: #202124; color: #fff; }
